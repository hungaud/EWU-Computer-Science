...
Node * getLast(LinkedList * theList) {
	if(theList == NULL) {
		printf("\n linkedList is NULL when trying to get last");
	}
...
void printListFile(const LinkedList * theList, void (*convertData)(void *, FILE * fp), FILE * fp) {
   int i;
   if(theList->head->next == NULL) {
      printf("The the list is empty\n");
   } else {
...
void printNumList(const LinkedList * theList, void (*convertData)(void *), int count) {
   int i;
   if(theList->head->next == NULL) {
      printf("The the list is empty\n");
   } else {
...
void printNumListFile(const LinkedList * theList, void (*convertData)(void *, FILE * fp), int count, FILE * fp) {
   int i;
   if(theList->head->next == NULL) {
      printf("The the list is empty\n");
   } else {
